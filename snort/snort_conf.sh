...
echo 'alert tcp  any any -> 20.0.0.0/24 any (msg:"Possible TCP DoS"; threshold: type both, track by_src, count 400, seconds 3; sid:10;rev:1;)' >>  /etc/snort/rules/icmp.rules
